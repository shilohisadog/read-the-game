...
**Health right now:** 4,553 archived · **4,490 published** · 63 refused · 73 unreconciled · 1,964 with a hero loop · **1,289 JS + 216 Python tests**
...
⏭ **WHAT IS OPEN** — the rest of `docs/test-program.md` §10:
**row 8 is half done** — the Tabletop blind spot (8 of the 19 escapes) was closed by
deleting unreachable code rather than instrumenting it, and what remains is motion
and gestures: `tools/browser/states.mjs` holds six states (opening, mid, moving,
step-back, step-forward, mark-door) and is NOT yet wired to anything or measured
against the 19. Then: visibility claims moving to the
