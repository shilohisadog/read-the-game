...
const LAB={faceoff:'Won the faceoff',hit:'Hit',giveaway:'Giveaway',takeaway:'Takeaway','blocked-shot':'Shot blocked','missed-shot':'Missed shot','shot-on-goal':'Shot on goal',penalty:'Penalty'};
let labelsOn=true;
/**
