...
function figMascot(g,px,py,size,jersey,out,o){
 ...
 if(!goal){
  ...
  g.beginPath(); g.moveTo(u*2.5,-u*4.3); g.lineTo(u*5.6,-u*0.35); g.stroke();
  g.strokeStyle='#12181d'; g.lineWidth=u*0.60;
  g.beginPath(); g.moveTo(u*5.4,-u*0.3); g.lineTo(u*7.0,-u*0.12); g.stroke();
  g.fillStyle='#0b0f13'; g.beginPath(); g.ellipse(u*7.9,-u*0.08,u*0.52,u*0.26,0,0,7); g.fill();
 }else{
  ...
  g.beginPath(); g.moveTo(u*3.7,-u*9.1); g.lineTo(u*6.5,-u*11.7); g.stroke();
 }
...
function figTabletop(g,px,py,size,jersey,out,o){
 ...
 if(!goal){
  ...
  g.strokeStyle=ink; g.lineWidth=u*0.92;
  g.beginPath(); g.moveTo(u*5.45,-u*0.22); g.lineTo(u*7.15,-u*0.10); g.stroke();
  g.lineCap='butt';
 }else{
