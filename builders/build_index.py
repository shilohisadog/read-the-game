...
@media (min-width:1180px){
  ...
  /* The one block on this page with no measure of its own. Every other paragraph
     caps at 56-70ch already; the limits cards are full-width boxes, so at 1240
     their text would run to about a hundred characters a line. */
  .wrap.front .limits{max-width:78ch}
  .hero:not([hidden]){
    display:grid;
